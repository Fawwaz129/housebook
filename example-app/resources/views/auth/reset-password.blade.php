    ...
    <form action="{{ route('password.update') }}" method="POST">
      ...
      <div class="flex mt-4 justify-center items-center">
        <div class="relative">
            ...
            <input name="email" type="email" value="{{ old('email', $request->email) }}"  id="input-group-1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none border-none focus:ring-0 block w-[340px] pl-10 p-2.5  dark:placeholder-gray-400 dark:text-white" placeholder="example@gmail.com">
          </div>
      </div>
      <div class="flex mt-4 justify-center items-center">
        <div class="relative">
